...
func (b *argsBuilder) Type(columnType column.Type) *argsBuilder {
...
func (b *argsBuilder) Build() column.Args {
	return b.argsMap
}
...
func (am *argsMap) Type() (column.Type, error) {
	if !am.columnTypeSet {
...
func (am *argsMap) SetType(colType column.Type) {
